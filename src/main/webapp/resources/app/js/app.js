...
(function() {
    ...
    angular
        .module('angle', [
            ...
            'app.mailbox',
            'app.utils',
            'oitozero.ngSweetAlert'//Eu que coloquei na Mão
        ]);
})();
...
(function() {
    ...
    angular
        ...
        .constant('APP_REQUIRES', {
            ...
            scripts: {
                'whirl':              ['resources/vendor/whirl/dist/whirl.css'],
                'classyloader':       ['resources/vendor/jquery-classyloader/js/jquery.classyloader.min.js'],
                'animo':              ['resources/vendor/animo.js/animo.js'],
                'fastclick':          ['resources/vendor/fastclick/lib/fastclick.js'],
                'modernizr':          ['resources/vendor/modernizr/modernizr.custom.js'],
                'animate':            ['resources/vendor/animate.css/animate.min.css'],
                'skycons':            ['resources/vendor/skycons/skycons.js'],
                'icons':              ['resources/vendor/fontawesome/css/font-awesome.min.css',
                    'resources/vendor/simple-line-icons/css/simple-line-icons.css'],
                'weather-icons':      ['resources/vendor/weather-icons/css/weather-icons.min.css',
                    'vendor/weather-icons/css/weather-icons-wind.min.css'],
                'sparklines':         ['resources/vendor/sparkline/index.js'],
                'wysiwyg':            ['resources/vendor/bootstrap-wysiwyg/bootstrap-wysiwyg.js',
                    'vendor/bootstrap-wysiwyg/external/jquery.hotkeys.js'],
                'slimscroll':         ['resources/vendor/slimScroll/jquery.slimscroll.min.js'],
                'screenfull':         ['resources/vendor/screenfull/dist/screenfull.js'],
                'vector-map':         ['resources/vendor/ika.jvectormap/jquery-jvectormap-1.2.2.min.js',
                ...
                'jquery-ui-widgets':  ['vendor/jquery-ui/ui/core.js',
                    'resources/vendor/jquery-ui/ui/widget.js',
                    'resources/vendor/jquery-ui/ui/mouse.js',
                    'resources/vendor/jquery-ui/ui/draggable.js',
                    'resources/vendor/jquery-ui/ui/droppable.js',
                    'resources/vendor/jquery-ui/ui/sortable.js',
                    'resources/vendor/jqueryui-touch-punch/jquery.ui.touch-punch.min.js'],
                'moment' :            ['resources/vendor/moment/min/moment-with-locales.min.js'],
                'inputmask':          ['vendor/jquery.inputmask/dist/jquery.inputmask.bundle.js'],
                'flatdoc':            ['vendor/flatdoc/flatdoc.js'],
                'codemirror':         ['vendor/codemirror/lib/codemirror.js',
                    'vendor/codemirror/lib/codemirror.css'],
                // modes for common web files
                'codemirror-modes-web': ['resources/vendor/codemirror/mode/javascript/javascript.js',
                    'vendor/codemirror/mode/xml/xml.js',
                    'vendor/codemirror/mode/htmlmixed/htmlmixed.js',
                    'vendor/codemirror/mode/css/css.js'],
                'taginput' :          ['vendor/bootstrap-tagsinput/dist/bootstrap-tagsinput.css',
                    'vendor/bootstrap-tagsinput/dist/bootstrap-tagsinput.min.js'],
                'filestyle':          ['resources/vendor/bootstrap-filestyle/src/bootstrap-filestyle.js'],
                'parsley':            ['resources/vendor/parsleyjs/dist/parsley.min.js'],
            ...
            modules: [
                ...
                {name: 'angularFileUpload',         files: ['resources/vendor/angular-file-upload/dist/angular-file-upload.js']},
                {name: 'ngImgCrop',                 files: ['vendor/ng-img-crop/compile/unminified/ng-img-crop.js',
                    'vendor/ng-img-crop/compile/unminified/ng-img-crop.css']},
                {name: 'ui.select',                 files: ['resources/vendor/angular-ui-select/dist/select.js',
                    'resources/vendor/angular-ui-select/dist/select.css']},
                {name: 'ui.codemirror',             files: ['resources/vendor/angular-ui-codemirror/ui-codemirror.js']},
                {name: 'angular-carousel',          files: ['resources/vendor/angular-carousel/dist/angular-carousel.css',
                    'resources/vendor/angular-carousel/dist/angular-carousel.js']},
                {name: 'infinite-scroll',           files: ['vendor/ngInfiniteScroll/build/ng-infinite-scroll.js']},
                {name: 'ui.bootstrap-slider',       files: ['vendor/seiyria-bootstrap-slider/dist/bootstrap-slider.min.js',
                    'vendor/seiyria-bootstrap-slider/dist/css/bootstrap-slider.min.css',
                    'vendor/angular-bootstrap-slider/slider.js']},
                {name: 'ui.grid',                   files: ['resources/vendor/angular-ui-grid/ui-grid.min.css',
                ...
                {name: 'ui.map',                    files: ['resources/vendor/angular-ui-map/ui-map.js']},
                {name: 'datatables',                files: ['resources/vendor/datatables/media/css/jquery.dataTables.css',
                    'resources/vendor/datatables/media/js/jquery.dataTables.js',
                    'resources/vendor/angular-datatables/dist/angular-datatables.js'], serie: true},
...
(function() {
    ...
    function RouteHelpersProvider(APP_REQUIRES) {
        ...
        function basepath(uri) {
            return 'resources/app/views/' + uri;
        }
